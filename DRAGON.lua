...
{{text = 'قناة بودي',url="t.me/S_a_i_d_i"}}, 
...
keyboard.inline_keyboard = {
{{text = 'قناة سورس صعيدي', url="t.me/S_a_i_d_i"}},
...
if DevSoFi(msg) then
local bl = 'مرحبا بك في كيب سورس صعيدي 𖥳'
local keyboard = {
...
local Text = ' 𖥳 تم ارسال الملصق من ⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n - '..Name
...
send(msg.chat_id_, msg.id_,' 𖥳 اصدار سورس صعيدي{ 3x☆}')
end
...
send(msg.chat_id_,0," 𖥳 الـعـضو  : {["..data.first_name_.."](T.ME/S_a_i_d_i)}\n 𖥳 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖥳 عذرا  ⇇{["..data.first_name_.."](T.ME/S_a_i_d_i)}\n 𖥳 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'الواد طه' or text == 'مـرات بــودي' or text == 'مـريم' or text == 'مريم' then
local Text = [[
...
حمايه↤سرعه↤دقه↤وامان
 قناه السورس ⇈⇊
[𝑾𝑬𝑳𝑪𝑶𝑴𝑺 𝑻𝑶 `sᴏᴜʀᴄᴇ sᴀɪᴅɪ´](http://t.me/S_a_i_d_i)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/S_a_i_d_i"}}, 
...
if text == 'العاب صعيدي' or text == 'العاب صعيدي' or text == 'العاب المتطوره' then  
local Text = [[  
...
send(msg.chat_id_, msg.id_, " 𖥳 لا تسطيع الواد عمر عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1965534755) then  
send(msg.chat_id_, msg.id_, " 𖥳 لا تسطيع حظر عمك مصطفى عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1871165209) then  
send(msg.chat_id_, msg.id_, "  𖥳 لا تسطيع حظر الواد ابو المجد عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1549578895) then  
send(msg.chat_id_, msg.id_, " 𖥳 لا تسطيع حظر الواد طه عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1965534755) then  
send(msg.chat_id_, msg.id_, " 𖥳 لا تسطيع كتم عمك مصطفى عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1871165209) then  
send(msg.chat_id_, msg.id_, " 𖥳 لا تسطيع كتم الواد ابو المجد عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1549578895) then  
send(msg.chat_id_, msg.id_, " 𖥳 لا تسطيع كتم الواد طه عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1372188096) then  
send(msg.chat_id_, msg.id_, " 𖥳 لا تسطيع الواد عمر عام")
...
t = ' 𖥳 ملفات السورس صعيدي ⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n ⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 𖥳 اهلا بك في متجر ملفات صعيدي\n 𖥳 ملفات السورس ⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n 𖥳 علامة تعني { ✔️ } ملف مفعل\n 𖥳 علامة تعني { ✖ } ملف معطل\n 𖥳 قناة سورس صعيدي⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n".." 𖥳 [اضغط هنا لدخول](t.me/S_a_i_d_i) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖥳 عذرا الملف لايدعم سورس صعيدي\n") 
end
return false
end
...
if #list == 0 then
t = " 𖥳 لا يوجد احد في قائمه صعيدي"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖥳 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'S_a_i_d_i')..')'
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك..🌚💘](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚💘](t.me/S_a_i_d_i)')
return false
end
...
[[
↑⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 𖥳  
↑⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺𝙄𝘿 ➱ #id
↑⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺𝙍𝘼𝙉𝙆 ➱  #stast 𖥳  
↑⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺??𝘼𝙎𝙂 ➱ #msgs 𖥳  
↑⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺𝗖𝗛 ➯  ↝@S_a_i_d_i↜ 𖥳  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
